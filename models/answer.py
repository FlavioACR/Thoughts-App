...
class Answers(Base):
   ...
   question_to_response_id = Column(Integer)
   #ForeignKey("questions.question_id", ondeleted="CASCADE"), nullable=False)
   user_responder_id       = Column(Integer, nullable=False)
